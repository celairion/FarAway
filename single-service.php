...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
  ...
  <?php
	...
	$views    	= get_post_meta(get_the_ID(), "views", true); if(empty($views)) $views = 0;
	$views 		= $views + 1;
...
?>
 			...
 			<div class="project-signle-content-main card">
                ...
                <div class="small_buttons_div_left  p-3">
                	<div class="container"   id="project-details-id">
							...
							<div class="row">
                <div class="col-md-3 column-details-1"><img src="<?php echo get_template_directory_uri() ?>/images/wallet_icon2.png" width="18" height="18" alt="budget" /> <?php echo __("Service Budget",'ProjectTheme'); ?> </div>
								<div class="col-md-9 column-details-2"><?php echo ProjectTheme_get_show_price(get_post_meta(get_the_ID(), 'price', true)); ?></div>
							</div>
			...
			<!-- ####################### -->
					...
					<h5 class="my-account-headline-1"><?php echo __('Service Description','ProjectTheme'); ?></h5>
		...
		?>
				...
				<div id="map" style="width: 100%; height: 300px;border:1px solid #ccc;float:left; border-radius:5px"></div>
...
codeAddress("<?php
 ...
 ?>");
		 ...
		 <?php endif; ?>
			...
			<h3 class="my-account-headline-1"><?php echo __('Related Projects','ProjectTheme'); ?></h3>
...
<?php
	...
	if(get_current_user_id() == $post->post_author)
	{
		?>
						...
						<li class="widget-container widget_text" id="ad-other-details">
									...
									<div class="mb-3"><?php printf(__('You are the owner of this service.','ProjectTheme')); ?></div>
	...
	?>
    <li class="widget-container widget_text" id="ad-other-details">
		<h3 class="widget-title text-center"><?php _e("Get in Contact",'ProjectTheme'); ?></h3>
		<p class="text-center">
        <?php _e('You can use the button below to get in contact with the service owner.','ProjectTheme') ?>
        </p>
         ...
         <?php
			 ...
			 if(get_current_user_id() == $post->post_autor) $is_author = 1;
    	...
    	<li class="widget-container widget_text" id="ad-other-details">
		<h3 class="widget-title text-center"><?php _e("Service Posted By",'ProjectTheme'); ?></h3>
        ...
        <p>
            	...
            	<br/><br/>
               <a href="<?php echo home_url(); ?>/?p_action=user_profile&post_author=<?php echo $post->post_author; ?>" class="btn btn-secondary btn-sm btn-block"><?php _e('See more about this user','ProjectTheme'); ?></a><br/>
