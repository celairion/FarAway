...
***************************************************************************/
		...
		echo '<h2 class="widget-title">'.__('Latest Trips','ProjectTheme'). '</h2>';
		$limit = 5;
		...
		$limit = apply_filters('ProjectTheme_filter_limit_latest_projects', $limit);
		 ...
		 global $wpdb, $custom_post_project_type_name;	
				 ...
				 ?>
                     ...
                     <?php endforeach; ?>
                     <?php else : ?> <?php $no_p = 1; ?>
                       <div class="padd100"><p class="center"><?php _e("Sorry, there are no posted Trips yet.",'ProjectTheme'); ?></p></div>
