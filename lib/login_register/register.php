		...
		<div id="main" class="wrapper-register">
				...
				<h3 class="h3-name"><?php printf(__("Register",'ProjectTheme')); ?></h3>
						  ...
						  <input type="hidden" name="action" value="register" />
							...
							<input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="service_provider" checked="checked" /> <?php _e('Reader','ProjectTheme'); ?><br/>
                            <input type="radio" class="do_input_radio" name="user_tp" id="user_tp" value="business_owner" /> <?php _e('Content Creator','ProjectTheme'); ?><br/>
							</p>
