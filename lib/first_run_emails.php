<?php
	...
	$opt = get_option('ProjectTheme_new_emails_14b9');
	if(empty($opt)):

	update_option('ProjectTheme_new_emails_14b9', 'DonE');
...
update_option('ProjectTheme_withdrawal_requested_admin_email_message', 'Hello admin,'.PHP_EOL.PHP_EOL.
	...
	update_option('ProjectTheme_withdrawal_requested_user_email_message', 'Hello admin,'.PHP_EOL.PHP_EOL.
			...
			update_option('ProjectTheme_deposit_money_wallet_email_subject', 'New deposit to your account: ##method_deposit##.');
			update_option('ProjectTheme_deposit_money_wallet_email_message', 'Hello ##username##,'.PHP_EOL.PHP_EOL.
					'You have just deposited money into your e-wallet account. See below the details of this deposit: '.PHP_EOL.

					'Amount: <b>##username##</b>  '.PHP_EOL.
					'Method: <b>##amount##</b>'.PHP_EOL.PHP_EOL.
