...
?>
  ...
  <?php do_action('ProjectTheme_step1_before_price'); ?>
	  ...
	  ?>
				...
				<li><hr color="#efefef" /></li>

				<li  class="<?php echo projecttheme_get_post_new_error_thing('hourly_paid') ?>">
				<?php echo projecttheme_get_post_new_error_thing_display('hourly_paid') ?>
 ...
 ?>
                ...
                <div class="small_buttons_div_left p-3">
									...
									<div class="container" id="project-details-id">
										...
										$hourly_paid = get_post_meta($PID_PID,'hourly_paid', true);
										...
										if($hourly_paid == "1")
										{
											...
											<div class="row">
												...
												<div class="col-md-8 column-details-2"><?php echo projecttheme_get_show_price(get_post_meta($PID_PID, 'hourly_rate', true)); ?></div>
											</div>
