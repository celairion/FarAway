...
<div class="col-sm-12 col-lg-12">
           ...
           <?php
				...
				if(isset($_POST['save-info']))
				{
					...
					$per_hour = sanitize_text_field($_POST['per_hour']);
					...
					$personal_info = sanitize_text_field($_POST['paypal_email']);
					update_user_meta($uid, 'paypal_email', $personal_info);

					$personal_info = sanitize_text_field($_POST['payza_email']);
					update_user_meta($uid, 'payza_email', $personal_info);

					$personal_info = sanitize_text_field($_POST['moneybookers_email']);
