...
class ProjectTheme_browse_by_category extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'description' => 'Show all categories and browse by category' );

		parent::__construct( 'ProjectTheme_browse_by_category', 'ProjectTheme - Browse by Category', $widget_ops );
	}
