...
***************************************************************************/
  ...
  $closed_project = get_post_meta($project, 'closed', true);
...
if($row->user == $current_user->ID)
{
 ...
 ?>
                ...
                <div class="card p-3"><div class="padd10 wk-cnt1">
                  ...
                  <div class="pb-2"><textarea name="text_message" <?php echo $closed_project == "1" ? "disabled" : "" ?> rows="" required cols="" class="txt-ar-chat form-control mb-3"></textarea></div>
                ...
                <div class="pb-2"> <input type="file" name="file_instant" class="" /> <?php _e('Only PDF, ZIP, Office files and Images.','ProjectTheme'); ?> </div>
                  ...
                  <div class="pb-2">  <input type="submit" name="send_chat_mes" <?php echo $closed_project == "1" ? "disabled" : "" ?> class="btn btn-primary" value="<?php _e('Send message','ProjectTheme') ?>" /></div>
