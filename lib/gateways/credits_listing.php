...
<div class="page_heading_me_inner">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="x_templ_1_pt">
			<div class="container">
    	<div class="mm_inn"><h1><?php printf(__("Pay item with eWallet - %s", 'ProjectTheme'), $post_pr->post_title ); ?></h1>
					...
					if(isset($_GET['pay'])):
							...
							else
							{
								...
								// echo $pid;
										...
										do_action('projecttheme_on_listing_am', get_current_user_id(), $total);
