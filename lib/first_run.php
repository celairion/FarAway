...
***************************************************************************/
	...
	//--------------------------------------------------------------------
		...
		ProjectTheme_insert_pages_account('ProjectTheme_my_account_contests_customer_id', 			'Contests', 				'[project_theme_my_account_contests_customer]', 			get_option('ProjectTheme_my_account_page_id') );
		ProjectTheme_insert_pages_account('ProjectTheme_my_account_contests_freelancer_id', 			'Contests', 				'[project_theme_my_account_contests_freelancer]', 			get_option('ProjectTheme_my_account_page_id') );
		...
		*/
		 //===========================================================================================================
			...
			$ss = "CREATE TABLE `".$wpdb->prefix."project_bids` (
				...
				$ss = "CREATE TABLE `".$wpdb->prefix."project_contest_submissions` (
					`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
					`date_made` BIGINT NOT NULL DEFAULT '0',
					`bid` DOUBLE NOT NULL DEFAULT '0',
					`pid` BIGINT NOT NULL DEFAULT '0',
					...
					`reserved1` VARCHAR( 255 ) NOT NULL DEFAULT '0',
					`date_choosen` BIGINT NOT NULL DEFAULT '0',
					`attached_file` BIGINT NOT NULL DEFAULT '0'
					) ENGINE = MYISAM ";
		...
		//----------------------------
			...
			$wpdb->query($ss);
				...
				$sql_option_my = "ALTER TABLE  `".$wpdb->prefix."project_contest_submissions` ADD  `result_url` TEXT NOT NULL ;";
				$wpdb->query($sql_option_my);


				$sql_option_my = "ALTER TABLE  `".$wpdb->prefix."project_contest_submissions` ADD  `description` TEXT NOT NULL ;";
				$wpdb->query($sql_option_my);
				...
				$sql_option_my = "ALTER TABLE  `".$wpdb->prefix."project_contest_submissions` ADD  `muted` VARCHAR(255) NOT NULL DEFAULT '0' ;";
				$wpdb->query($sql_option_my);
 ...
 //$wpdb->query($ss);
			...
			$wpdb->query($ss);
				...
				$ss = " CREATE TABLE `".$wpdb->prefix."project_escrows` (
				 ...
				 $ss = " CREATE TABLE `".$wpdb->prefix."project_bills_site` (
					...
					$ss = "CREATE TABLE `".$wpdb->prefix."project_contest_messages` (
						`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
						...
						`pid` BIGINT NOT NULL DEFAULT '0' ,
						`datemade` INT NOT NULL DEFAULT '0', 
						`attached` BIGINT NOT NULL DEFAULT '0'
						) ENGINE = MYISAM ;
						";
				$wpdb->query($ss);
	...
	$ss = "CREATE TABLE `".$wpdb->prefix."project_contest_deposits` (
		`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
		`uid` BIGINT NOT NULL DEFAULT '0',
		`pid` BIGINT NOT NULL DEFAULT '0',
		`amount` VARCHAR( 255 ) NOT NULL ,
		`released` TINYINT NOT NULL DEFAULT '0',
		`released_date` INT NOT NULL DEFAULT '0' ,
		`datemade` INT NOT NULL DEFAULT '0' 
		) ENGINE = MYISAM ;
		";
$wpdb->query($ss);
		...
		$ss = "CREATE TABLE `".$wpdb->prefix."project_contest_orders` (
			`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
			`buyer` BIGINT NOT NULL DEFAULT '0',
			`freelancer` BIGINT NOT NULL DEFAULT '0',
			`pid` BIGINT NOT NULL DEFAULT '0',
		...
		$ss = "ALTER TABLE `".$wpdb->prefix."project_contest_orders` ADD  `completion_date` BIGINT NOT NULL DEFAULT '0';";
		$wpdb->query($ss);


		$ss = "ALTER TABLE `".$wpdb->prefix."project_contest_orders` ADD  `cancelled_date` BIGINT NOT NULL DEFAULT '0';";
		$wpdb->query($ss);
