...
$projecthememnupg("project_theme_mnu", __('License Key','ProjectTheme'), '<i class="fas fa-key"></i> '.__('License Key','ProjectTheme'),$capability, "license-key", 'projectTheme_license_keys');
...
function projectTheme_options()
{
  ...
  <form method="post" action="">
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Multiple categories when posting a project:','') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable User Separation:','') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Project Files:','') ?></td>
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'ProjectTheme_enable_project_files'); ?></td>
				...
				<tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Show Subitems on categories and locations pages:','') ?></td>
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'ProjectTheme_show_subcats_enbl'); ?></td>
				...
				<tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Allow bidders to contact project owner before placing a bid:','') ?></td>
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'ProjectTheme_allow_before_placing_a_bid'); ?></td>
				...
				<tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable project message board:','') ?></td>
        ...
        <td>&nbsp;</td>
				...
				<tr>
				<td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
				<td ><?php _e('Enable Credits Direct Payment:','') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Hide from search engines Option:','') ?></td>
        ...
        <td ><?php _e('Moderate Private Messages:','') ?></td>
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'ProjectTheme_moderate_private_messages'); ?></td>
				...
				<tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Project Location:','') ?></td>
        ...
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'projectTheme_show_project_views'); ?></td>
				...
				<tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Admin approves each project:','') ?></td>
        <td><?php echo ProjectTheme_get_option_drop_down($arr, 'projectTheme_admin_approves_each_project'); ?></td>
				...
				<tr>
				<td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
				<td ><?php _e('Enable user activation link in email:','') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Blog:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Big Main Menu:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Slider on Front Page:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Enable Stretch Area (front page):','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Project Listing Max Period (simple project):','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Project Listing Max Period (featured project):','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Category slug in links:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Location slug in links:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td ><?php _e('Projects slug in links:','ProjectTheme') ?></td>
        ...
        <tr>
        <td valign=top width="22"><?php echo $menu_admin_project_theme_bull; ?></td>
        <td valign="top" ><?php _e('Custom CSS:','ProjectTheme') ?></td>
        ...
        <td></td>
        <td ></td>
        <td><input type="submit"  class="button button-primary button-large" name="my_submit"   value="<?php _e('Save these Settings!','ProjectTheme') ?>" /></td>
        </tr>
...
function projectTheme_orders()
{
	...
	{
			global $wpdb;
			$id =$_GET['delete_entry'];
			$s = "delete from ".$wpdb->prefix."project_orders where id='$id'";
			$wpdb->query($s);
  ...
  <div id="tabs1" style="display: none; ">
    	<?php
				...
				$prf = $wpdb->prefix;
				$s = "select SQL_CALC_FOUND_ROWS distinct * from ".$prf."project_orders orders where  order_status='0' order by id desc limit $offset, $amount_per_page";
				$r = $wpdb->get_results($s);
				...
				foreach($r as $row)
				{
					...
					$bid = projectTheme_get_winner_bid($pid); $bidsa = $bid;
					...
					$tm_d = get_post_meta($pid, 'expected_delivery', true);
					...
					echo '<th><a href="'.get_admin_url().'admin.php?page=orders&pj1='.$pj.'&mark_delivered='.$row->id.'">Mark Delivered</a> |

					<a href="'.get_admin_url().'admin.php?page=orders&pj1='.$pj.'&delete_entry='.$row->id.'">Delete Entry</a>
				...
				//-------------------------------------------------------
 				 ...
 				 //echo $own_pagination->display_pagination();
        ...
        <div id="tabs2" style="display: none; ">
					...
					<?php
						...
						$prf = $wpdb->prefix;
						$s = "select SQL_CALC_FOUND_ROWS distinct * from ".$prf."project_orders orders where  order_status='1' order by id desc limit $offset, $amount_per_page";
						$r = $wpdb->get_results($s);
						...
						foreach($r as $row)
						{
							...
							echo '<th><a href="'.get_admin_url().'admin.php?page=orders&pj1='.$pj.'&mark_completed='.$row->id.'">Mark Completed</a> |
         ...
         <div id="tabs3" style="display: none; ">
					 ...
					 <?php
	 					...
	 					$prf = $wpdb->prefix;
	 					$s = "select SQL_CALC_FOUND_ROWS distinct * from ".$prf."project_orders orders where  order_status='2' order by id desc limit $offset, $amount_per_page";
	 					$r = $wpdb->get_results($s);
...
function projectTheme_payment_methods()
{
	...
	if(isset($_POST['ProjectTheme_save1']))
	{
		...
		update_option('project_theme_paypal_client_secret', 				trim($_POST['project_theme_paypal_client_secret']));
		update_option('project_theme_paypal_client_id', 						trim($_POST['project_theme_paypal_client_id']));
          ...
          <form method="post" action="<?php echo get_admin_url(); ?>admin.php?page=payment-methods&active_tab=tabs1">
            <table width="100%" class="sitemile-table">
                    ...
                    <td><input type="text" name="project_theme_appid" value="<?php echo get_option('project_theme_appid'); ?>" size="45" /> eg: APP-80W217485P519543 </td>
									...
									<tr><td colspan=3><h3>Paypal Developer Console Data</h3></td>
			 		</tr>


									<tr><td valign=top width="22"><?php ProjectTheme_theme_bullet(); ?></td>
					 <td ><?php _e('Client ID:','ProjectTheme'); ?></td>
					 <td><input type="text" name="project_theme_paypal_client_id" value="<?php echo get_option('project_theme_paypal_client_id'); ?>" size="55" /> </td>
					 </tr>


					 <tr><td valign=top width="22"><?php ProjectTheme_theme_bullet(); ?></td>
		<td ><?php _e('Client Secret:','ProjectTheme'); ?></td>
		<td><input type="text" name="project_theme_paypal_client_secret" value="<?php echo get_option('project_theme_paypal_client_secret'); ?>" size="55" /> </td>
		</tr>
            ...
            <table width="100%" class="sitemile-table">
							...
							<tr>
							                    ...
							                    <td><textarea cols="65" rows="4" name="ProjectTheme_left_side_footer"><?php echo stripslashes(get_option('ProjectTheme_left_side_footer')); ?></textarea></td>
																	...
																	<tr>
																						<td valign=top width="22"><?php ProjectTheme_theme_bullet(__('This will appear in the right side of the footer area - account pages.','ProjectTheme')); ?></td>
																						<td valign="top" ><?php _e('Text (right side - account pages):','ProjectTheme'); ?></td>
...
function projectTheme_pricing_options()
{
	...
	$hourly_rate = array( "yes" => __('Yes','ProjectTheme'), "no" => __("no",'ProjectTheme'));
	...
	if(isset($_POST['ProjectTheme_save_prj_budget']))
	{
		...
		$ProjectTheme_enable_hourly_rate 												= trim($_POST['ProjectTheme_enable_hourly_rate']);
		update_option('ProjectTheme_enable_hourly_rate', 					$ProjectTheme_enable_hourly_rate);
	...
	do_action("projecttheme_action_on_project_fees_submit");
  ...
  <ul>
	...
	<?php do_action("projecttheme_action_on_project_fees_tabs") ?>
  </ul>


  <?php do_action("projecttheme_action_on_project_fees_content") ?>
...
<form method="post" action="<?php echo get_admin_url(); ?>admin.php?page=pricing-settings">
		<table width="100%" class="sitemile-table">
		 ...
		 <tr>
		<td valign=top width="22"><?php ProjectTheme_theme_bullet(); ?></td>
		<td ><?php _e('Enable hourly rate:','ProjectTheme'); ?></td>
		<td><?php echo ProjectTheme_get_option_drop_down($hourly_rate, 'ProjectTheme_enable_hourly_rate'); ?></td>
		</tr>
